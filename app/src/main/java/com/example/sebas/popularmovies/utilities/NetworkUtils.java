...
import com.example.sebas.popularmovies.MainActivity;
...
/**
 * Created by Sebas on 4/24/17.
 */

public final class NetworkUtils {

    private static final String MODB_API_KEY =  "USE_YOUR_API_KEY";

    private static final String MODB_BASE_URL = "https://api.themoviedb.org/3/movie";

    private static final String POPULAR_MOVIES_URL = MODB_BASE_URL + "/popular";

    private static final String TOP_MOVIES_URL = MODB_BASE_URL + "/top_rated";

    private static final String API_KEY_PARAM = "api_key";

    private static final String MODB_BASE_IMAGES_URL = "https://image.tmdb.org/t/p/";
    ...
    public static URL buildUrl(MoviesListType type) {
        ...
        Uri builtUri = Uri.parse(stringUrl)
                .buildUpon()
                .appendQueryParameter(API_KEY_PARAM, MODB_API_KEY)
                .build();
    ...
    public static String getPosterBaseUrl(Context context) {
        ...
        return MODB_BASE_IMAGES_URL + imageW;
    }
}